...
/**
 * Combined (Legacy): Preview + ImageCapture + VideoCapture + ImageAnalysis.
 *
 * All four use cases bound in a single `bindToLifecycle()` call, with the
 * Preview rendered into a [PreviewView] embedded via [AndroidView].
 *
 * Compare with: simplistic/usecase/UseCaseCombined.kt
 */
@SuppressLint("MissingPermission") // gated by PermissionGate + Permission.RECORD_AUDIO.isGranted()
@Composable
fun LegacyUseCaseCombined() {
